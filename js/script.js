...
/** 
 * Bouge le postit dans la zone défini
 * @param {boolean} onBouge - Si onBouge est active la condition s'exécute
 * 
 * Change la taille dans la zone défini
 * @param {boolean} onTaille - Si onTaille est active la condition s'exécute
 * 
 * @param {string} idBouge - id du postit
...
/**
 * Fonction permettant d'ajouter un bouton dans un postit
 * 
